...
<div class="main-content container-fluid">
  ...
  <div class="col-xs-12">
                <div class="panel panel-default">
                  <div class="panel-heading panel-heading-divider">Dataset<span class="panel-subtitle">Dataset Harga Emas PT.Xyz.</span></div>
                        ...
                        <form name="tambah" id="tambah" action="{{route('administrator.dataset.import')}}" method="POST" enctype="multipart/form-data">
                          ...
                          <input type="hidden" name="_method" value="POST">
                            <div class="form-group file-field input-field">
                              ...
                              <a class="btn btn-success" href="/storage/file/coba.xlsx" download>Unduh Template</a>
                            </div>

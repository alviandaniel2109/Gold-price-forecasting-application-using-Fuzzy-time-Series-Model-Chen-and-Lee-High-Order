                ...
                <div class="panel panel-default">
                  ...
                  <div class="panel panel-default">
                    ...
                    <div class="panel panel-default">
                      ...
                      <div class="panel panel-default">
                        <div class="panel-heading panel-heading-divider">Hasil Peramalan Model Chen Berdasarkan orde {{$orde}}.<span class="panel-subtitle"></span></div>
                        <div class="panel-body">
                          ...
                          <div class="panel panel-default">
                            <div class="panel-heading panel-heading-divider">Hasil Peramalan Model Lee Berdasarkan orde {{$orde}}.<span class="panel-subtitle"></span></div>
                            <div class="panel-body">
                      ...
                      <div class="panel panel-default">
                        <div class="panel-heading panel-heading-divider">Perbandingan Peramalan Model Chen dan Model Lee Berdasarkan orde {{$orde}}.<span class="panel-subtitle"></span></div>
                        <div class="panel-body">
                  ...
                  <div class="panel panel-default">
                    ...
                    <div class="panel panel-default">
                      <div class="panel-heading panel-heading-divider">Kesalahan Peramalan Model Chen Berdasarkan orde {{$orde}}.<span class="panel-subtitle"></span></div>
                      <div class="panel-body">
                        ...
                        <div class="row">
                          <div class="container">
                            ...
                            <p>Pada model chen didapati bahwasanya Afer dan RSME adalah :{{$mean_chen['afer']*100}} dan {{$mean_chen['rmse']}}</p>
                    ...
                    <div class="panel panel-default">
                      <div class="panel-heading panel-heading-divider">Kesalahan Peramalan Model Lee Berdasarkan orde {{$orde}}.<span class="panel-subtitle"></span></div>
                      <div class="panel-body">
...
<div class="panel panel-default">
  <div class="panel-heading panel-heading-divider">PERAMALAN HARGA 7 HARI KEDEPAN<span class="panel-subtitle"></span></div>
  <div class="panel-body">
    ...
    <div style="padding-left:20px;padding-right:20px;"class="row">
        ...
        <?php 
                            $ordo = $orde;
                            if($ordo == $orde){
                              echo "Berdasarkan Grafik Signifikan Peramalan 7 hari Kedepan Pada Model Chen dan lee adalah NAIK";
                            }else{
                              echo "Berdasarkan Grafik Signifikan Peramalan 7 hari Kedepan Pada Model Chen dan lee adalah NAIK";
                            }
                            ?>
                    ...
                    <div class="panel panel-default">
                      ...
                      <div class="panel-body">
                        ...
                        <div style="padding-left:20px;padding-right:20px;"class="row">
                            <br>
                            @if ($hasil['model']=='sama')
                              <p>Berdasarkan hasil perhitungan Peramalan Harga Emas Menggunakan Fuzzy Time Series dengan membandingkan Model Chen dan Lee didapatkan bahwa Model Chen dan Model Lee memiliki tingkat akurasi yang sama yaitu mencapai {{$hasil['akurasi']}}%
                                </p>
                            @else
                              <p>Berdasarkan hasil perhitungan Peramalan Harga Emas Menggunakan Fuzzy Time Series dengan membandingkan Model Chen dan Lee didapatkan bahwa Model {{$hasil['model']}} Lebih baik dengan tingkat akurasi mencapai {{$hasil['akurasi']}}%
                                </p>
                            @endif
         ...
         data: [
           ...
           @endforeach
			...
			options: {
				...
				title: {
					display: true,
					text: 'Perbandingan Hasil Peramalan'
				},
        plugins: {
    datalabels: {
        display: false,
